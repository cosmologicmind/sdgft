...
class TestSpectralIndex:
    ...
    def test_blue_spectrum_rejection(self):
        """Verifies that any blue spectrum formula like n_s = 1.0126 is physically excluded."""
        n_s_blue = 1.0126
        # A blue spectrum (n_s > 1) is falsified by Planck CMB 2018 at more than 10 sigma
        # Planck 2018 limit: n_s = 0.9649 +/- 0.0042
        sigma_dev = abs(n_s_blue - 0.9649) / 0.0042
        assert sigma_dev > 10.0
