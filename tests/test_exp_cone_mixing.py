...
class TestMixingAngles:
    ...
    def test_theta_12_formula(self):
        """theta_12 = TBM * (1 - 1/24) = TBM * 23/24."""
        expected = THETA_12_TBM * (1.0 - 1.0 / 24.0)
        assert abs(THETA_12_GEO - expected) < 1e-12

    def test_theta_12_value(self):
        """theta_12 ~ 33.80 deg."""
        assert abs(THETA_12_GEO - 33.80) < 0.01
    ...
    def test_theta_12_vs_observed(self):
        ...
        assert sigma < 1.0  # Major improvement over old 5.87 sigma
