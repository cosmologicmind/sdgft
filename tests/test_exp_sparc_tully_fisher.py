...
# SPARC data lives outside the repo — skip data-dependent tests on CI
_SPARC_DATA_DIR = "/home/david/Coding/data/sparc"
_SPARC_AVAILABLE = os.path.isdir(_SPARC_DATA_DIR)
_skip_no_sparc = pytest.mark.skipif(
    not _SPARC_AVAILABLE,
    reason="SPARC data directory not available",
)
