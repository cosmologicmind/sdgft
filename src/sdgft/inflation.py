...
def spectral_index(n: float, n_e: float) -> float:
    ...
    Note on Erratum (Paper 04/24):
        Legacy drafts mentioned a formula n_s = 1 + n^R_f/67 = 1.0126.
        This was an algebraic projection error that predicted a blue spectrum,
        which is phenomenologically excluded at >10 sigma. The correct R^n
        relation implemented below yields a red tilt n_s ~ 0.967, in perfect
